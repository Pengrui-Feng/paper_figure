...
data=data[data['espresso_temp'].str.contains('nan') == False]
#data=data[data['doppio_temp'].str.contains('nan') == False]
ttemp = pd.Series(str2ndlist(data['obs_temp']))
tdepth = pd.Series(str2ndlist(data['depth']))
...
Data = pd.DataFrame({'turtle_temp':t_temp,'fvcom_temp':f_temp,'roms_temp':r_temp,'bottom_depth':bottom_depth})
...
sdev = np.array([taylor_stats4['sdev'][0], taylor_stats4['sdev'][1], 
                 taylor_stats2['sdev'][1], taylor_stats3['sdev'][1]])
crmsd = np.array([taylor_stats4['crmsd'][0], taylor_stats4['crmsd'][1], 
                  taylor_stats2['crmsd'][1], taylor_stats3['crmsd'][1]])
ccoef = np.array([taylor_stats4['ccoef'][0], taylor_stats4['ccoef'][1], 
